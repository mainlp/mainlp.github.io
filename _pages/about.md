...
In broad terms, our aim is to make NLP models more robust and inclusive, so that they can deal better with underlying shifts in data due to language variation and so that NLP is more fair and user-centric.

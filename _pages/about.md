...
groups: [staff, admin, affiliated, support, alumni]
staff:
  title: Staff
  people:
    - name: Barbara Plank
...
support:
  title: Support staff 
    - name: You?
      description: we have openings for student assistants for projects and teaching assistance, see <a href="/jobs">→Open positions</a> 
alumni:
  title: Alumni 
    - name: Anna Barwig

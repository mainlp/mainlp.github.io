...
- *NLP for climate change.* The problem of climate change is of global and societal importance. For students interested in real-world societal applications, this theme provides multiple thesis projects including but not limited to: the extraction of sustainability information, the extraction of key players or stance from text. References: [Stede & Patz, 2021](https://aclanthology.org/2021.nlp4posimpact-1.2/). Level: BSc or MSc. (topic currently under development) 

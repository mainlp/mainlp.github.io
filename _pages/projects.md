...
- *Dialect identification on social media and/or across genres.*  How can we robustly distinguish between closely-related dialects on social media like Twitter? Or: How can we robustly distinguish between closely-related dialects across genres/text types?  For example, German Wikipedias exist, but how well does a model trained on Wikipedia transfer to another text type like social media? For students interested in creation of a gold standard and classification, or transfer learning. Reference (for Italian and Swiss German): [Aepli et al., 2022](https://aclanthology.org/2022.vardial-1.1.pdf), [Aepli and Hollenstein, 2014](https://noe-eva.github.io/publication/noah2015/). [Siewert et al., 2020](https://aclanthology.org/2020.vardial-1.3.pdf) and references above, [Aepli et al., 2022](https://aclanthology.org/2022.vardial-1.1.pdf). Level: MSc or BSc.

...
At MaiNLP we aim to make NLP models more robust, so that they can deal better with underlying shifts in data due to language variation.
 ...
 <img class="avatar" src="/assets/img/max_ling_var.jpg" alt="Linguistic variation and NLP. Credits: Max Mueller-Eberstein" width="auto" height="500px">
...
- *Computational Job Market Analysis.* Extraction of skills from job postings, taxonomy-driven pre-training, multlinguality. We are particularly interested in extending this work to German.  [See references of MultiSkill project](#multiskill)
